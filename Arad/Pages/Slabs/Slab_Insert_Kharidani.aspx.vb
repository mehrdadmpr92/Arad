Public Class Slab_Insert_Kharidani
    Inherits System.Web.UI.Page


    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Page.Title = "ثبت قطعه خریدنی"
            Me.MultiView1.SetActiveView(kharidaniSubmit)
    ...
    Protected Sub Edit_Btn_Click(sender As Object, e As EventArgs)
        Try
            ...
            Else
                ...
                Dim err As String = slab.Slab_kharidani_Update(Me.ViewState("EditSlabId"), PerSlabNameEdit_Txt.Text,
    ...
    Protected Sub Delete_Btn_Click(sender As Object, e As EventArgs)
        Try
            ...
            Dim slab As New Slabs
            Dim err As String = slab.Slab_kharidani_Delete(Me.ViewState("Delete_SlabId"))
